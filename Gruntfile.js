...
module.exports = function (grunt) {
  ...
  var getLessVarsData = function () {
    var filePath = path.join(__dirname, 'assets/less/variables.less');
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['assets/js/src/*.js', 'assets/js/*.js', '!assets/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'assets/js/customize.min.js'
      },
      docsJs: {
        src: configBridge.paths.docsJs,
        dest: 'assets/js/docs.min.js'
      }
    },
    ...
    less: {
      ...
      compileTheme: {
        options: {
          ...
          sourceMapFilename: 'assets/css/<%= pkg.name %>-theme.css.map'
        },
    ...
    autoprefixer: {
      ...
      theme: {
        ...
        src: 'assets/css/<%= pkg.name %>-theme.css'
      },
      docs: {
